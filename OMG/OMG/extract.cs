...
namespace OMG
{
    public partial class extract : Form
    {
        ...
        {
            Extract("OMG", ".\\", "extract", "AxInterop.WMPLib.dll"); //Extract
            Extract("OMG", ".\\", "extract", "Interop.WMPLib.dll"); //Extract
            Extract("OMG", ".\\", "extract", "omg.mp4"); //Extract
            Extract("OMG", ".\\", "extract", "del.bat"); //Extract
            VideoPlay.Start();
        }
